...
## 结论
漫旅 AI 智能助手通过前后端协作，实现了流畅的对话体验：SSE 流式输出、Markdown 渲染、工具调用可视化与上下文管理。前端以 ChatPage.js 为核心，配合认证与主页，形成完整的用户旅程；后端通过 DashScope/Qwen 提供强大推理能力。MockInterviewService 作为补充，进一步拓展了保研场景下的智能问答与面试辅助能力。整体架构清晰、扩展性强，适合持续迭代与功能扩展。
